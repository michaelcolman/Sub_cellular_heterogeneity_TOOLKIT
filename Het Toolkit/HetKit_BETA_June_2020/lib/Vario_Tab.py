...
def create_tabVario(self):
	...
	self.spinBC1.setSingleStep(5)
	self.spinBC1.setMinimum(5)
	self.spinBC1.setMaximum(100)
	...
	self.spinBS1.setSingleStep(5)
	self.spinBS1.setMinimum(5)
	self.spinBS1.setMaximum(100)
	...
	self.spinBS2.setSingleStep(5)
	self.spinBS2.setMinimum(5)
	self.spinBS2.setMaximum(100)
