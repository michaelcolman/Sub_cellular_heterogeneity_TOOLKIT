...
def create_tabSRF(self):
	...
	self.SB_SRFDimX.setMinimum(0)
	self.SB_SRFDimX.setMaximum(1001)	
	...
	self.SB_SRFDimY.setMinimum(0)
	self.SB_SRFDimY.setMaximum(1001)
	...
	self.SB_SRFDimZ.setMinimum(0)
	self.SB_SRFDimZ.setMaximum(1001)
	...
	self.SB_NeighbourVar.setValue(1.00)
	self.SB_NeighbourVar.setMinimum(0.00)
	self.SB_NeighbourVar.setMaximum(50.00)
